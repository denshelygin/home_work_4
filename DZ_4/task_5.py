...
with open('Pr/2.txt', 'w') as data:
    data.write('TTTTTTTTTTTTRRRYYYYYYYYYYYYYYU')

with open('Pr/2.txt', 'r') as data:
...
with open('Pr/2.txt', 'r') as file:
    decoded_string = file.read()

with open('Pr/3.txt', 'w') as file:
